...
class DiscountCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ExpansionTile( //EXPANDE QUANDO CLICADO
        title: Text(
          "Cupom de desconto",
        ...
        children: <Widget>[
          Padding(
            ...
            child: TextFormField(
              ...
              initialValue: CartModel.of(context).couponCode ?? "", //CASO TENHA CUPOM APLICADO, MOSTRA
              onFieldSubmitted: (text){ //QUANDO DER ENTER, VAI APLICAR O CUPOM
